function b(t, e) {
  for (var r = 0; r < e.length; r++) {
    ...
    if (typeof n != "string" && !Array.isArray(n)) {
      for (const u in n)
        if (u !== "default" && !(u in t)) {
          const f = Object.getOwnPropertyDescriptor(n, u);
...
var R = v.prototype = new H();
R.constructor = v;
j(R, l.prototype);
R.isPureReactComponent = !0;
var C = Array.isArray, i = { H: null, A: null, T: null, S: null, V: null }, $ = Object.prototype.hasOwnProperty;
function d(t, e, r, n, u, f) {
  return r = f.ref, {
    $$typeof: E,
    type: t,
    key: e,
...
function a(t, e, r, n, u) {
  ...
  if (s)
    return u = u(t), s = n === "" ? "." + y(t, 0) : n, C(u) ? (r = "", s != null && (r = s.replace(g, "$&/") + "/"), a(u, e, r, "", function(M) {
      return M;
    })) : u != null && (T(u) && (u = B(
      u,
      r + (u.key == null || t && t.key === u.key ? "" : ("" + u.key).replace(
        g,
        "$&/"
      ) + "/") + s
    )), e.push(u)), 1;
...
var A = typeof reportError == "function" ? reportError : function(t) {
...
o.cloneElement = function(t, e, r) {
  ...
  var n = j({}, t.props), u = t.key, f = void 0;
  if (e != null)
    for (s in e.ref !== void 0 && (f = void 0), e.key !== void 0 && (u = "" + e.key), e)
  ...
  return d(t.type, u, void 0, void 0, f, n);
};
...
o.createElement = function(t, e, r) {
  ...
  if (t && t.defaultProps)
    for (n in s = t.defaultProps, s)
      u[n] === void 0 && (u[n] = s[n]);
  return d(t, f, void 0, void 0, null, u);
};
...
o.startTransition = function(t) {
  ...
  try {
    var n = t(), u = i.S;
    u !== null && u(r, n), typeof n == "object" && n !== null && typeof n.then == "function" && n.then(Z, A);
  } catch (f) {
    A(f);
  } finally {
    i.T = e;
...
O.exports = o;
var N = O.exports;
const J = /* @__PURE__ */ Y(N), V = /* @__PURE__ */ b({
  __proto__: null,
  default: J
}, [N]);
export {
