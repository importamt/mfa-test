...
var QueriesObserver = (_j = class extends Subscribable {
  ...
  const index2 = __privateGet(this, _observers2).indexOf(observer);
  if (index2 !== -1) {
    __privateSet(this, _result, replaceAt(__privateGet(this, _result), index2, result));
    __privateMethod(this, _QueriesObserver_instances, notify_fn2).call(this);
  }
}, notify_fn2 = function() {
  var _a2;
...
function dehydrateQuery(query, serializeData, shouldRedactErrors) {
  ...
  return {
    ...
    ...query.state.status === "pending" && {
      promise: (_a2 = query.promise) == null ? void 0 : _a2.then(serializeData).catch((error) => {
...
function dehydrate(client2, options = {}) {
  var _a2, _b2, _c2, _d2;
  const filterMutation = options.shouldDehydrateMutation ?? ((_a2 = client2.getDefaultOptions().dehydrate) == null ? void 0 : _a2.shouldDehydrateMutation) ?? defaultShouldDehydrateMutation;
  const mutations = client2.getMutationCache().getAll().flatMap(
    (mutation) => filterMutation(mutation) ? [dehydrateMutation(mutation)] : []
  );
  const filterQuery = options.shouldDehydrateQuery ?? ((_b2 = client2.getDefaultOptions().dehydrate) == null ? void 0 : _b2.shouldDehydrateQuery) ?? defaultShouldDehydrateQuery;
  const shouldRedactErrors = options.shouldRedactErrors ?? ((_c2 = client2.getDefaultOptions().dehydrate) == null ? void 0 : _c2.shouldRedactErrors) ?? defaultShouldRedactErrors;
  const serializeData = options.serializeData ?? ((_d2 = client2.getDefaultOptions().dehydrate) == null ? void 0 : _d2.serializeData) ?? defaultTransformerFn;
...
function hydrate(client2, dehydratedState, options) {
  ...
  const deserializeData = ((_a2 = options == null ? void 0 : options.defaultOptions) == null ? void 0 : _a2.deserializeData) ?? ((_b2 = client2.getDefaultOptions().hydrate) == null ? void 0 : _b2.deserializeData) ?? defaultTransformerFn;
  ...
  mutations.forEach(({ state, ...mutationOptions2 }) => {
    ...
    mutationCache.build(
      client2,
      {
        ...(_a3 = client2.getDefaultOptions().hydrate) == null ? void 0 : _a3.mutations,
    ...
    ({ queryKey, state, queryHash, meta, promise, dehydratedAt }) => {
      ...
      if (query) {
        ...
        query = queryCache.build(
          client2,
          {
            ...(_a3 = client2.getDefaultOptions().hydrate) == null ? void 0 : _a3.queries,
...
var HydrationBoundary = ({
  ...
  const hydrationQueue = reactExports.useMemo(() => {
    if (state) {
      ...
      if (newQueries.length > 0) {
        hydrate(client2, { queries: newQueries }, optionsRef.current);
      }
  ...
  reactExports.useEffect(() => {
    if (hydrationQueue) {
      hydrate(client2, { queries: hydrationQueue }, optionsRef.current);
    }
  }, [client2, hydrationQueue]);
  return children;
};
...
const ReactQuery = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  CancelledError,
  HydrationBoundary,
  InfiniteQueryObserver,
  ...
  dehydrate,
  experimental_streamedQuery: streamedQuery,
  focusManager,
  hashKey,
  hydrate,
...
var objectIs$1 = "function" === typeof Object.is ? Object.is : is$1, useState$1 = React$1.useState, useEffect$2 = React$1.useEffect, useLayoutEffect$1 = React$1.useLayoutEffect, useDebugValue$3 = React$1.useDebugValue;
...
var objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore$1 = shim.useSyncExternalStore, useRef$1 = React.useRef, useEffect$1 = React.useEffect, useMemo$1 = React.useMemo, useDebugValue$2 = React.useDebugValue;
...
const RoutingContext = reactExports.createContext(null);
function RoutingProvider({ children }) {
  const [pathname, setPathname] = reactExports.useState(typeof window !== "undefined" ? window.location.pathname : "/");
  ...
  reactExports.useEffect(() => {
    ...
    window.addEventListener("mfa:route-changed", handleRouteChange);
    window.addEventListener("popstate", handlePopstate);
    return () => {
      window.removeEventListener("mfa:route-changed", handleRouteChange);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RoutingContext.Provider, { value: { pathname, navigate, params, query }, children });
}
...
function initializeQueryClient(ssrQueries = {}) {
...
function MfaQueryProvider({ children, ssrQueries }) {
  const queryClient = reactExports.useMemo(() => {
...
function NotificationCenter() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
    ...
    gap: "10px"
  }, children: notifications.map((notification) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        background: notification.type === "error" ? "#ff6b6b" : notification.type === "success" ? "#51cf66" : "#339af0",
        color: "white",
        padding: "12px 16px",
        borderRadius: "8px",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: "bold", marginBottom: "4px" }, children: notification.title }),
        notification.message && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "14px", opacity: 0.9 }, children: notification.message })
      ]
    },
    notification.id
  )) });
}
function MfaGlobalProvider({ children, ssrData = {} }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(MfaQueryProvider, { ssrQueries: ssrData.queries, children: [
    children,
    /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationCenter, {})
  ] });
}
const useGlobalUser = useUserStore;
const useGlobalNotification = useNotificationStore;
const Search = ({ size = 24, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "svg",
  {
    width: size,
    height: size,
...
const User = ({ size = 24, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "svg",
  {
    width: size,
    height: size,
...
const ChevronLeft = ({ size = 24, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "svg",
  {
    width: size,
    height: size,
...
const ChevronRight = ({ size = 24, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "svg",
  {
    width: size,
    height: size,
...
const Play = ({ size = 24, fill, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "svg",
  {
    width: size,
    height: size,
    ...
    strokeLinejoin: "round",
    ...props,
    children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z" })
  }
);
const THEMES = {
  LIGHT: "light",
...
if (typeof window !== "undefined" && !window.__MFA_APPS__) {
  window.__MFA_APPS__ = /* @__PURE__ */ new Map();
}
function createMfaApp(appName, AppComponent) {
  let root2 = null;
  return {
    /**
     * 컴포넌트를 DOM에 마운트
    ...
    mount(containerOrId) {
      ...
      root2 = clientExports.createRoot(container);
      root2.render(/* @__PURE__ */ jsxRuntimeExports.jsx(AppComponent, {}));
      window.__MFA_APPS__.set(appName, { root: root2, Component: AppComponent });
      AppComponent.root = root2;
    ...
    unmount() {
      if (root2) {
        ...
        AppComponent.root = null;
        console.log(`❌ ${appName} 언마운트 완료`);
      }
    }
  };
}
function enableHMR(meta, appName, Component2) {
  const hot = meta.hot;
  if (!hot) return;
  hot.accept((newModule) => {
    ...
    const NewComponent = newModule.default || newModule[Component2.name];
    if (!NewComponent) {
      console.warn(`HMR 실패: 새 컴포넌트를 찾을 수 없습니다.`);
      return;
    }
    app.root.render(/* @__PURE__ */ jsxRuntimeExports.jsx(NewComponent, {}));
    NewComponent.root = app.root;
    window.__MFA_APPS__.set(appName, { ...app, Component: NewComponent });
    console.log(`✅ HMR 적용 완료: ${appName}`);
  });
}
if (typeof window !== "undefined") {
  window.React = React$4;
  window.ReactDOM = ReactDOM$1;
  window.ReactDOMClient = { createRoot: clientExports.createRoot };
...
//# sourceMappingURL=mfa-framework.js.map
