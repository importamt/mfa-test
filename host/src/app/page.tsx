...
export default function HomePage() {
      ...
      try {
        ...
        if (window.MfaFramework) {
          ...
          if (MicroFrontendHost) {
            ...
            await host.loadApp('@mfa/micro-app-1')
            await host.mountApp('@mfa/micro-app-1', 'mfa-container')
          }
        } else {
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-4">MFA Home</h1>
